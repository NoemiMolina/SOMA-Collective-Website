...
const Home = () => {
    ...
    return (
        ...
        <div className="louisDazy-container">
            ...
            <div className="louisDazy-container__section section--presentation">
                <div className="louisDazy-container__section__item">
                    <img src={presentation} alt="Presentation" className="presentation-image" />
                </div>
                <div className="louisDazy-container__section__item">
                ...
                <div className="louisDazy-container__section__item">
                    {presentationImages.slice(0, 2).map((img, index) => (
                        <img src={img.src} alt={img.title} className="img-test" />
                        // <div
                        //     className="large-card"
                        //     key={index}
                        //     onClick={() => navigate(img.route)}
            ...
            <div className="louisDazy-container__section">
                <div className="louisDazy-container__section__item ">ITEM 1</div>
            </div>
        </div>
    );
};
