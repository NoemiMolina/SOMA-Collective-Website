    ...
    <div className="polygon-layout">
        <div className="text-section">
            ...
            <div className="socials">
                ...
                <a href="https://www.instagram.com/polygon1993/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <SlSocialInstagram />
                </a>
                <a href="https://x.com/Polygon1993?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', marginLeft: '10px' }}>
                    <FaXTwitter />
                </a>
            </div>
