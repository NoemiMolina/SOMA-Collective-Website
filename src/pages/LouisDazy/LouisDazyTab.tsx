...
const LouisDazyTab = () => {
    ...
    return (
        <div className="louisDazy-layout">
            <div className="container">
                <h1 className="title">Louis Dazy</h1>
                <p className="photographer">The Photographer</p>
                <img src={louisDazyImage} alt="LouisDazy img" className="louisDazy-image" />
            ...
            <div className="presentation-img-container">
                <img src={TechNoir} alt="Tech Noir gif" className="gif-right-large" />
                <p className="art-caption">'Tech Noir'</p>
            </div>
            <div className="img-container">
                <div className="img-item">
                    <img src={YoungHearts} alt="Young Hearts gif" className="art-image" />
                    <p className="art-caption">'Young Hearts'</p>
                </div>
                <div className="img-item">
                    <img src={ParisienneMoonlight} alt="Parisienne Moonlight img" className="art-image" />
                    <p className="art-caption">'Parisienne Moonlight'</p>
                </div>
                <div className="img-item">
                    <img src={Yearning} alt="Yearning gif" className="art-image" />
                    <p className="art-caption">'Yearning'</p>
                </div>
                <div className="img-item">
                    <img src={Smokescreens} alt="Smokescreens gif" className="art-image" />
                    <p className="art-caption">'Smokescreens'</p>
                </div>
                <div className="img-item">
                    <img src={Escapism} alt="Escapism img" className="art-image" />
