            ...
            <div className="content-wrapper">
                <div className="presentation">
                    ...
                    <div className="socials" style={{fontSize: '1em'}}>
                        ...
                        <a href="https://www.instagram.com/louisdazy/" target="_blank" rel="noopener noreferrer" className="social-icon" style={{ fontSize: '1.5em', margin: '0 20px', color:'black'}}>
                            <SlSocialInstagram />
                        </a>
                        <a href="https://x.com/LouisDazy" target="_blank" rel="noopener noreferrer" className="social-icon" style={{ fontSize: '1.5em', margin: '0 20px', color:'black'}}>
                            <FaXTwitter />
                        </a>
                    ...
                    <div className="artistSliderGallery-wrapper">
                        {[...louisDazyImages.slice(0), ...louisDazyImages.slice(0)].map((image, index) => (
                            <div key={index} className="page-container__section__item animPic artistSlide">
                                ...
                                <p className="art-caption dazy" style={{bottom:'25%', fontSize:'0.5em'}}>{`'${image.title}' `}</p>
                            </div>
                        ))}
                    </div>
                </div>
